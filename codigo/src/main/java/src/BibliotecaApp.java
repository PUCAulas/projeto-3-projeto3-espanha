...
public class BibliotecaApp {
    ...
    while (true) {
        ...
        if (scanner.hasNext()) {
            ...
            System.out.println("Erro ao identificar entrada, retornando ao menu anterior.");
            return;
        }
    }
}
        ...
        if (scanner.hasNext()) {
            ...
            switch (opcaoCadastro) {
                ...
                case "4":
                    return; 
                default:
                    System.out.println("Opção inválida. Por favor, escolha uma opção válida (1, 2, 3 ou 4.");
            }
        } else {
            System.out.println("Erro ao identificar entrada, retornando ao menu anterior.");
            return;
